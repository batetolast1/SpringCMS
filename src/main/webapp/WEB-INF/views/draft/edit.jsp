...
<body>
    ...
    <form:form modelAttribute="draftDto">
        <fieldset>
            <legend>Draft data:</legend>
            <form:hidden path="id"/>
            ...
            <br/>
            <form:label path="authorDto">Author (optional): </form:label>
            ...
            <br/>
            <form:label path="categoryDtos">Categories (optional): </form:label>
